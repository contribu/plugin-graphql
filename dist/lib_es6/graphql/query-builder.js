...
var QueryBuilder = /** @class */ (function () {
    ...
    QueryBuilder.buildRelationsQuery = function (model, path) {
        ...
        model.getRelations().forEach(function (field, name) {
            var relatedModel;
            var fieldAsRelation = field;
            if (fieldAsRelation instanceof context.components.BelongsToMany ||
            ...
            else if (fieldAsRelation instanceof context.components.BelongsTo ||
                ...
                context.logger.log("WARNING: unknown field type. Fallback to attribute name", fieldAsRelation);
            }
